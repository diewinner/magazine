export const BurgerSvg = ({height, width}) => {
  return (
      <svg height={height} id="Layer_1"  version="1.1" viewBox="0 0 32 32" width={width} xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
